...
function App() {
  ...
  function teamAndScore(whichTeam, amount){
    if(whichTeam === 'Cowboys'){
      return hScore + amount;
    } else if (whichTeam === 'Giants'){
      return aScore + amount;
    } else {
    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="awayButtons__fieldGoal" onClick={()=> setHScore(teamAndScore('Cowboys', 2))}>Home Safety</button>
        </div>
        <div className="awayButtons">
          ...
          <button className="awayButtons__fieldGoal" onClick={()=> setAScore(teamAndScore('Giants', 2))}>Away Safety</button>
        </div>
      </section>
    </div>
  );
